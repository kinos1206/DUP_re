...
class PixelizationModel():
    ...
    def backward_all_net(self):
        ...
        fake_B_bi_x8 = self.change_size(fake_B_small_x8, size=size_A)
        fake_B_bi_x6 = self.change_size(fake_B_small_x6, size=size_A)
        fake_B_bi_x4 = self.change_size(fake_B_small_x4, size=size_A)
        ...
        # L1 loss of GridNet
        loss_gridnet_IO_L1 = self.criterionL1(fake_B_bi_x8, self.real_A.float())
        loss_gridnet_IO_L1 += self.criterionL1(fake_B_bi_x6, self.real_A.float())
        loss_gridnet_IO_L1 += self.criterionL1(fake_B_bi_x4, self.real_A.float())
        loss_gridnet_IO_L1 *= lambda_weight

        # MSSSIM loss of GridNet
        loss_gridnet_MS_L1 = msssim_loss(fake_B_bi_x8, self.real_A.float())
        loss_gridnet_MS_L1 += msssim_loss(fake_B_bi_x6, self.real_A.float())
        loss_gridnet_MS_L1 += msssim_loss(fake_B_bi_x4, self.real_A.float())
        loss_gridnet_MS_L1 *= 1
        
        # Gradient loss of GridNet
        fake_B_small_x8_gradient_x1, fake_B_small_x8_gradient_y1 = self.get_gradient(fake_B_bi_x8)
        fake_B_small_x6_gradient_x1, fake_B_small_x6_gradient_y1 = self.get_gradient(fake_B_bi_x6)
        fake_B_small_x4_gradient_x1, fake_B_small_x4_gradient_y1 = self.get_gradient(fake_B_bi_x4)
        real_A_gradient_x1, real_A_gradient_y1 = self.get_gradient(self.real_A.float())

        loss_gridnet_G_L1_x8 = self.criterionL1(fake_B_small_x8_gradient_x1, real_A_gradient_x1) \
                             + self.criterionL1(fake_B_small_x8_gradient_y1, real_A_gradient_y1)
        loss_gridnet_G_L1_x6 = self.criterionL1(fake_B_small_x6_gradient_x1, real_A_gradient_x1) \
                             + self.criterionL1(fake_B_small_x6_gradient_y1, real_A_gradient_y1)
        loss_gridnet_G_L1_x4 = self.criterionL1(fake_B_small_x4_gradient_x1, real_A_gradient_x1) \
                             + self.criterionL1(fake_B_small_x4_gradient_y1, real_A_gradient_y1)
        '''
        fake_B_small_x8_gradient_x1, fake_B_small_x8_gradient_y1, fake_B_small_x8_gradient_x2, fake_B_small_x8_gradient_y2 = self.get_gradient(fake_B_bi_x8)
        fake_B_small_x6_gradient_x1, fake_B_small_x6_gradient_y1, fake_B_small_x6_gradient_x2, fake_B_small_x6_gradient_y2 = self.get_gradient(fake_B_bi_x6)
        fake_B_small_x4_gradient_x1, fake_B_small_x4_gradient_y1, fake_B_small_x4_gradient_x2, fake_B_small_x4_gradient_y2 = self.get_gradient(fake_B_bi_x4)
        real_A_gradient_x1, real_A_gradient_y1 ,real_A_gradient_x2, real_A_gradient_y2 = self.get_gradient(self.real_A.float())

        loss_gridnet_G_L1_x8 = self.criterionL1(fake_B_small_x8_gradient_x1, real_A_gradient_x1) \
                             + self.criterionL1(fake_B_small_x8_gradient_y1, real_A_gradient_y1) \
                             + self.criterionL1(fake_B_small_x8_gradient_x2, real_A_gradient_x2) \
                             + self.criterionL1(fake_B_small_x8_gradient_y2, real_A_gradient_y2)
        loss_gridnet_G_L1_x6 = self.criterionL1(fake_B_small_x6_gradient_x1, real_A_gradient_x1) \
                             + self.criterionL1(fake_B_small_x6_gradient_y1, real_A_gradient_y1) \
                             + self.criterionL1(fake_B_small_x6_gradient_x2, real_A_gradient_x2) \
                             + self.criterionL1(fake_B_small_x6_gradient_y2, real_A_gradient_y2)
        loss_gridnet_G_L1_x4 = self.criterionL1(fake_B_small_x4_gradient_x1, real_A_gradient_x1) \
                             + self.criterionL1(fake_B_small_x4_gradient_y1, real_A_gradient_y1) \
                             + self.criterionL1(fake_B_small_x4_gradient_x2, real_A_gradient_x2) \
                             + self.criterionL1(fake_B_small_x4_gradient_y2, real_A_gradient_y2)
        '''
        ...
        self.count += 1
        if(self.count == 200):
            self.save_img(real_A_gradient_x1,'real_A_gradient_x')
            self.save_img(real_A_gradient_y1,'real_A_gradient_y')
            ...
            self.save_img(fake_B_small_x4_gradient_x1,'fake_B_small_x4_gradient_x')
        '''
        ...
        self.loss_gridnet = loss_gridnet_adversarial + loss_gridnet_IO_L1 + loss_gridnet_MS_L1 +  loss_gridnet_G_L1
        ...
        fake_B_x8_processed_gradient_x1, fake_B_x8_processed_gradient_y1 = self.get_gradient(fake_B_x8_processed)
        fake_B_x6_processed_gradient_x1, fake_B_x6_processed_gradient_y1 = self.get_gradient(fake_B_x6_processed)
        fake_B_x4_processed_gradient_x1, fake_B_x4_processed_gradient_y1 = self.get_gradient(fake_B_x4_processed)
        fake_B_x8_gradient_x1, fake_B_x8_gradient_y1 = self.get_gradient(fake_B_x8)
        fake_B_x6_gradient_x1, fake_B_x6_gradient_y1 = self.get_gradient(fake_B_x6)
        fake_B_x4_gradient_x1, fake_B_x4_gradient_y1 = self.get_gradient(fake_B_x4)
        loss_pixelnet_G_L1_x8 = self.criterionL1(fake_B_x8_processed_gradient_x1, fake_B_x8_gradient_x1) \
                              + self.criterionL1(fake_B_x8_processed_gradient_y1, fake_B_x8_gradient_y1)
        loss_pixelnet_G_L1_x6 = self.criterionL1(fake_B_x6_processed_gradient_x1, fake_B_x6_gradient_x1) \
                              + self.criterionL1(fake_B_x6_processed_gradient_y1, fake_B_x6_gradient_y1)
        loss_pixelnet_G_L1_x4 = self.criterionL1(fake_B_x4_processed_gradient_x1, fake_B_x4_gradient_x1) \
                              + self.criterionL1(fake_B_x4_processed_gradient_y1, fake_B_x4_gradient_y1)
        loss_pixelnet_G_L1 = (loss_pixelnet_G_L1_x8 + loss_pixelnet_G_L1_x6 + loss_pixelnet_G_L1_x4)
        loss_pixelnet_G_L1 *= 1
        '''
        fake_B_x8_processed_gradient_x1, fake_B_x8_processed_gradient_y1, fake_B_x8_processed_gradient_x2, fake_B_x8_processed_gradient_y2 = self.get_gradient(fake_B_x8_processed)
        fake_B_x6_processed_gradient_x1, fake_B_x6_processed_gradient_y1, fake_B_x6_processed_gradient_x2, fake_B_x6_processed_gradient_y2 = self.get_gradient(fake_B_x6_processed)
        fake_B_x4_processed_gradient_x1, fake_B_x4_processed_gradient_y1, fake_B_x4_processed_gradient_x2, fake_B_x4_processed_gradient_y2 = self.get_gradient(fake_B_x4_processed)
        fake_B_x8_gradient_x1, fake_B_x8_gradient_y1, fake_B_x8_gradient_x2, fake_B_x8_gradient_y2 = self.get_gradient(fake_B_x8)
        fake_B_x6_gradient_x1, fake_B_x6_gradient_y1, fake_B_x6_gradient_x2, fake_B_x6_gradient_y2 = self.get_gradient(fake_B_x6)
        fake_B_x4_gradient_x1, fake_B_x4_gradient_y1, fake_B_x4_gradient_x2, fake_B_x4_gradient_y2 = self.get_gradient(fake_B_x4)
        loss_pixelnet_G_L1_x8 = self.criterionL1(fake_B_x8_processed_gradient_x1, fake_B_x8_gradient_x1) \
                              + self.criterionL1(fake_B_x8_processed_gradient_y1, fake_B_x8_gradient_y1) \
                              + self.criterionL1(fake_B_x8_processed_gradient_x2, fake_B_x8_gradient_x2) \
                              + self.criterionL1(fake_B_x8_processed_gradient_y2, fake_B_x8_gradient_y2)
        loss_pixelnet_G_L1_x6 = self.criterionL1(fake_B_x6_processed_gradient_x1, fake_B_x6_gradient_x1) \
                              + self.criterionL1(fake_B_x6_processed_gradient_y1, fake_B_x6_gradient_y1) \
                              + self.criterionL1(fake_B_x6_processed_gradient_x2, fake_B_x6_gradient_x2) \
                              + self.criterionL1(fake_B_x6_processed_gradient_y2, fake_B_x6_gradient_y2)
        loss_pixelnet_G_L1_x4 = self.criterionL1(fake_B_x4_processed_gradient_x1, fake_B_x4_gradient_x1) \
                              + self.criterionL1(fake_B_x4_processed_gradient_y1, fake_B_x4_gradient_y1) \
                              + self.criterionL1(fake_B_x4_processed_gradient_x2, fake_B_x4_gradient_x2) \
                              + self.criterionL1(fake_B_x4_processed_gradient_y2, fake_B_x4_gradient_y2)
        loss_pixelnet_G_L1 = (loss_pixelnet_G_L1_x8 + loss_pixelnet_G_L1_x6 + loss_pixelnet_G_L1_x4)
        loss_pixelnet_G_L1 *= 1
        '''
        ...
        self.loss_pixelnet = loss_pixelnet_adversarial + loss_pixelnet_IO_L1 + loss_pixelnet_MS_L1 + loss_pixelnet_G_L1
